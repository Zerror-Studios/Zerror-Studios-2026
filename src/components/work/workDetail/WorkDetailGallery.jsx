    ...
    <>
      <div ref={container} className="wrk_images_parent w-full">
        <div className="w-full center flex-col  relative">
          ...
          <img className=' mob_1 max-sm:w-[30vw]  absolute right-20 top-[35%]' src="/images/work/image_3.png" alt="" />
          <img className=' mob_2 max-sm:hidden  absolute right-20 bottom-0 md:bottom-[5%]' src="/images/work/image_4.png" alt="" />
        </div>
        ...
        <div className="w-full center flex-col relative">
          ...
          <img className=' mob_3 max-sm:w-[30vw] absolute right-20 bottom-[5%]' src="/images/work/image_9.png" alt="" />
