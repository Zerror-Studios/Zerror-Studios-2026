...
const EcommStoreSection = () => {
    return (
        <>
            <div className="w-full  padding pr-0! mt-10 md:mt-32 py-10! md:py-32!  bg_blue relative text-white flex">
                <div className="w-[30%] flex flex-col   justify-between">
                    ...
                    <img src="/images/expertisePage/e-comm/cmsCards/card_3.png" className=' h-full object-cover absolute right-0  top-0 w-[68%]' alt="" />
                <div className="w-[70%] relative flex items-end  justify-center flex-col">

                    <img src="/images/expertisePage/e-comm/store_img.png" className=  '  w-[85%] relative z-10' alt="" />
