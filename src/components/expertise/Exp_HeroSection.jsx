...
const Exp_HeroSection = () => {
  ...
  return (
    <div className=" noise-bg  relative w-full h-screen bg_blue flex flex-col  max-sm:pt-44! py-24! md:py-0 justify-between   padding md:pb-24! md:grid grid-cols-[70%_30%] md:items-end   text-white z-90">
