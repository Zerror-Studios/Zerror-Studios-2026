  ...
  return (
    <section className="w-full h-full ">
      <div className="w-full p-5 md:p-10 h-full bg-black flex flex-col justify-center text-white">
        <div className="md:w-[85%] space-y-6">
          <h2 data-para-effect className="text-4xl md:text-6xl  primary-font leading-none">
            Synthesis: <span className="opacity-50">Why This <br className='max-sm:hidden' /> Matters</span>
          </h2>

          <div data-para-effect className="text-2xl hidden md:block italic opacity-60 leading-tight">
            <p>We build systems designed for your business.</p>
            <p>Not websites forced into templates.</p>
          </div>
          <div data-para-effect className="text-xl md:hidden italic opacity-60 leading-tight">
            <p>We build systems designed for your business. Not websites forced into templates.</p>
          </div>

          <p data-para-effect className="  leading-tight opacity-70  md:max-w-3xl">
